        ...
        <div className="flex justify-center">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl">
            {integrantes.map((integrante) => (
              <div
                key={integrante.id}
                className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 flex flex-col items-center text-center"
              >
                ...
                <div className="p-6 w-full">
                  ...
                  <div className="space-y-2 mb-4">
                    ...
                    <p className="text-gray-500 text-sm">{integrante.cargo}</p>
                  </div>
                  ...
                  <div className="flex justify-center space-x-4">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-gray-800 hover:text-black transition-colors transform hover:scale-110"
                      title="GitHub"
                    >
                      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
